defmodule HandlerTest do
  ...
  test "GET /faq-bigfoot" do
    request = """
    GET /faq-bigfoot HTTP/1.1\r
    Host: example.com\r
    User-Agent: ExampleBrowser/1.0\r
    Accept: */*\r
    \r
    ...
    HTTP/1.1 200 OK\r
    Content-Type: text/html\r
    Content-Length: 798\r
    \r
    <h1>FrequentlyAskedQuestions</h1>
    <ul>
      <li>
        <p><strong>Have you really seen Bigfoot?</strong></p>
        <p>Yes! In this <a href=\"https://www.youtube.com/watch?v=MlGsWJNw0Qg\">totally believable video</a>!</p>
      </li>
      <li>
