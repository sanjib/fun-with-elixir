defmodule Refuge.WildthingsTest do
  ...
  describe "bears" do
    ...
    @valid_attrs %{hibernate: true, name: "some name", type: "some type"}
    @update_attrs %{hibernate: false, name: "some updated name", type: "some updated type"}
    @invalid_attrs %{hibernate: nil, name: nil, type: nil}
